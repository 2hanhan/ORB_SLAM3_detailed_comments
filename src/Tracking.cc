...
namespace ORB_SLAM3
{
    ...
    void Tracking::PreintegrateIMU()
    {
        ...
        if (!mCurrentFrame.mpPrevFrame)
        {
            ...
            mCurrentFrame.setIntegrated(); //设置做完预积分标志位
            return;
        }
        ...
        while (true)
        {
            ...
            bool bSleep = false;
            {
                //------------[mpPrevFrame]-------------------------[mCurrentFrame]--------[keyframe的时间轴]
                //--[.][.][.]-------------------------------------------------------------------------------[情况1的IMU数据]
                //----------[.][.][.][.][.][.][.][.][.][.][.][.][.][.][.][.][.]---------------------------------[情况2的IMU数据]
                //---------------------------------------------------------[.][.][.][.][.][.][.][.][.][.]-----[情况3的IMU数据]
                unique_lock<mutex> lock(mMutexImuQueue);
                if (!mlQueueImuData.empty())
                {
                    ...
                    {
                        mlQueueImuData.pop_front(); //本次用不上
                    }
                    // 同样最后一个的imu数据时间戳也不能理当前帧时间间隔多余0.001
                    else if (m->t < mCurrentFrame.mTimeStamp - mImuPer)
                    {
                        mvImuFromLastFrame.push_back(*m);
                        mlQueueImuData.pop_front(); //下次用不上
                    }
                    else
                    {
                        // 本次和下次都能用得上的
                ...
                {
                    break;
                    bSleep = true; //?直接break了,到不了这一步
                }
            }
            if (bSleep) //? 这个变量就不可能是true
                usleep(500);
        }
